<?php
    ...
    $to         = 'r24malho@uwaterloo.ca';  // put your email here
    ...
    if ( mail( $to, $subject, $contents, $headers ) ) {
        ...
        $result = array( 'response' => 'error', 'message'=>'<strong>Sorry For Inconvenience!</strong>No mail service is available as if for now.Please drop mail directly on above Email-id mentioned. '  );
    }
